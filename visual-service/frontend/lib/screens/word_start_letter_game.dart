...
class WordStartLetterGame extends StatefulWidget {
  const WordStartLetterGame({super.key});

  @override
  State<WordStartLetterGame> createState() => _WordStartLetterGameState();
}

class _WordStartLetterGameState extends State<WordStartLetterGame> with TickerProviderStateMixin {
  ...
  final List<WordQuestion> _questions = [
    WordQuestion(
      word: 'අත',
      missingFirstLetterText: '_ ත',
      correctLetter: 'අ',
      options: ['අ', 'ඉ', 'ඔ', 'එ'],
      imagePath: 'assets/thumbnails/hand.jpg',
    ),
    WordQuestion(
      word: 'අහස',
      missingFirstLetterText: '_ හස',
      correctLetter: 'අ',
      options: ['ඉ', 'අ', 'එ', 'ඔ'],
      imagePath: 'assets/thumbnails/ahasa.jpg',
    ),
    WordQuestion(
      word: 'අම්මා',
      missingFirstLetterText: '_ ම්මා',
      correctLetter: 'අ',
      options: ['ඔ', 'එ', 'ඉ', 'අ'],
      imagePath: 'assets/thumbnails/amma.jpg',
    ),
    WordQuestion(
      word: 'අල',
      missingFirstLetterText: '_ ල',
      correctLetter: 'අ',
      options: ['එ', 'ඔ', 'අ', 'ඉ'],
      imagePath: 'assets/thumbnails/potato.jpg',
    ),
  ];
