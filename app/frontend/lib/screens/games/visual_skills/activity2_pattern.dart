      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final double patternFontSize = isSmallScreen ? 34.0 : 44.0;
            final double optionFontSize = isSmallScreen ? 38.0 : 50.0;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Wrap(
                            ...
                            children: [
                              ...currentRound.pattern.map((item) => Text(item, style: TextStyle(fontSize: patternFontSize))),
                              // Missing spot
                              Container(
                                ...
                                child: Center(
                                  child: _isCorrect 
                                    ? Text(currentRound.options[currentRound.correctOptionIndex], style: TextStyle(fontSize: patternFontSize)) 
