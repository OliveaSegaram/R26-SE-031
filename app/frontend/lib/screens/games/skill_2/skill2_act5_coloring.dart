...
class Skill2Act5Coloring extends StatefulWidget {
  final ActivityNode? activityNode;
  final bool isRemedial;
  const Skill2Act5Coloring({super.key, this.activityNode, this.isRemedial = false});

  @override
  State<Skill2Act5Coloring> createState() => _Skill2Act5ColoringState();
}

class _Skill2Act5ColoringState extends State<Skill2Act5Coloring> {
