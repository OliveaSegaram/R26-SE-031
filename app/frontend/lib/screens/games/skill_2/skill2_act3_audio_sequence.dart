...
class Skill2Act3AudioSequence extends StatefulWidget {
  final ActivityNode? activityNode;
  final bool isRemedial;
  const Skill2Act3AudioSequence({super.key, this.activityNode, this.isRemedial = false});

  @override
  State<Skill2Act3AudioSequence> createState() => _Skill2Act3AudioSequenceState();
}

class _Skill2Act3AudioSequenceState extends State<Skill2Act3AudioSequence> {
