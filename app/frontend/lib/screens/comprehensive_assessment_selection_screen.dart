...
class ComprehensiveAssessmentSelectionScreen extends StatefulWidget {
  ...
  @override
  State<ComprehensiveAssessmentSelectionScreen> createState() => _ComprehensiveAssessmentSelectionScreenState();
}

class _ComprehensiveAssessmentSelectionScreenState extends State<ComprehensiveAssessmentSelectionScreen> {
  ...
  Future<void> _fetchStudentData() async {
    ...
    if (mounted) {
      final student = students.firstWhere((s) => s['id'] == widget.studentId, orElse: () => null);
      if (student != null) {
        final compResults = (student['comprehensive_assessment_results'] as Map?)?.cast<String, dynamic>() ?? {};
        setState(() {
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    _buildPremiumCategoryCard(
                      ...
                      isCompleted: _completedCategories.containsKey('basic'),
                    ),
                    _buildPremiumCategoryCard(
                      context: context, 
                      category: 'reading', 
                      ...
                      isCompleted: _completedCategories.containsKey('reading'),
                    ),
                    _buildPremiumCategoryCard(
                      context: context, 
                      category: 'writing', 
                      ...
                      isCompleted: _completedCategories.containsKey('writing'),
                    ),
                    _buildPremiumCategoryCard(
                      context: context, 
                      category: 'other', 
                      ...
                      isCompleted: _completedCategories.containsKey('other'),
                    ),
                ...
                if (isCompleted)
                  Container(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        const Icon(Icons.check_circle_rounded, size: 14, color: AppColors.gentleGreen),
